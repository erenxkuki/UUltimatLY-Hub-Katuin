...
getgenv().Faster = { 
    ['CDK Super Fast'] = true, -- Spawn Admin 
...
getgenv().Setting = { -- Setting Script 
...
getgenv().Quest = { -- Farm Quest / ทำเควส
    ...
    ['Quest Dough Awaken'] = { -- Dough Awaken + Mirror Fractal 
...
if _G.Switch_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		if game:GetService("CoreGui"):FindFirstChild('UUltimatLY Hub') then
			game:GetService("CoreGui"):FindFirstChild('UUltimatLY Hub'):Destroy()
		end
		-- UUltimatLY_Hub
		local Switch_Hub = Instance.new("ScreenGui")
		UUltimatLY_Hub.Name = "UUltimatLY Hub"
		UUltimatLY_Hub.Parent = game:GetService("CoreGui")
		UUltimatLY_Hub.Enabled = false
		...
		F_Level.Name = "Level"
		F_Level.Parent = game:GetService("CoreGui")["UUltimatLY Hub"]
		...
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Fragments.Text = "UUltimatLY Hub"
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Position = UDim2.new(0.5, 0, -0.2, 0)
		game:GetService("CoreGui")["UUltimatLY Hub"].Level.Fragments.TextStrokeTransparency = 1
		
		-- Time
		local F_Text2 = Instance.new("Frame")
		F_Text2.Name = "Text2"
		F_Text2.Parent = game:GetService("CoreGui")["UUltimatLY Hub"]
		...
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Fragments.Text = ""
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
		game:GetService("CoreGui")["UUltimatLY Hub"].Text2.Fragments.TextStrokeTransparency = 1
