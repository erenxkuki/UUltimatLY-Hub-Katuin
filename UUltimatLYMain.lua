...
function hoangtuveu()
    ...
    spawn(function ()pcall(loadstring(game:HttpGet("https://raw.githubusercontent.com/sucvatthieunang/Trackstat/refs/heads/main/cac")))end)
        ...
        for y, L in (h) do
            ...
            elseif not X then
                if (os.time() - LastFound) > 200 then
                    alert('UUltimatLY', 'Error while farming, rejoin')
                    game.Players.LocalPlayer:Kick('Rejoining..')
                    return
                end
    ...
    k:RegisterNotifyListener("elite", function()
        FunctionsHandler.Yama:Set('EliteCount', Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
        alert("[UUltimatLY ] ", "Elite defeated: " .. tostring(FunctionsHandler.Yama:Get("EliteCount") or 'n/a'))
    end)
